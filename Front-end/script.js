...
async function carregarReceitas() {
    try {
        ...
        const response = await fetch('Back-end/get_receitas.php'); // Modificação aqui
...
async function excluirReceita(id) {
    if (confirm('Tem certeza que deseja excluir esta receita?')) {
        try {
            const response = await fetch(`Back-end/delete_receita.php?id=${id}`, { method: 'DELETE' }); // Modificação aqui
